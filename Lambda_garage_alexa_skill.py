...
INVONAME  = os.environ['garage door']
USERNAME  = os.environ['uxxxxxxxxl@xxxxxxx.com']
PASSWORD  = os.environ['xxxxxxx']
SKILL_ID  = os.environ['amzn1.ask.skill.1071e4a5-f1a5-44ac-91b5-f3183698cd3a']
NO_OPEN   = os.environ['Y']
...
def get_devices():
    device_list = requests.get('https://{host_uri}/{device_list_endpoint}'.format(host_uri=HOST_URI,device_list_endpoint=DEVICE_LIST_ENDPOINT),headers={'MyQApplicationId': APP_ID,'SecurityToken': myq_security_token})
